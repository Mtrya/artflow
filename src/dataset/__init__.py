...
__all__ = [
    ...
    "RowLengthMetadata",
    "METADATA_VERSION",
    "build_row_length_metadata",
    "build_length_metadata",
    "collate_fn",
    "parse_dataset_mix",
    "load_mixed_dataset",
    "get_dataset_weights",
...
_LAZY = {
    ...
    "build_row_length_metadata": (".length_metadata", "build_row_length_metadata"),
    "build_length_metadata": (".length_metadata", "build_length_metadata"),
