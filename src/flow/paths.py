...
class BaseAlgorithm(ABC):
    ...
    @abstractmethod
    def compute_loss(self, model_output: torch.Tensor, z0: torch.Tensor, z1: torch.Tensor, t: torch.Tensor) -> torch.Tensor:
        """
...
class FlowMatchingDiffusion(BaseAlgorithm):
    ...
    def _velocity_target(self, z0: torch.Tensor, z1: torch.Tensor, t: torch.Tensor) -> torch.Tensor:
        if t.dim() == 1:
            t = t.view(-1, 1, 1, 1)
