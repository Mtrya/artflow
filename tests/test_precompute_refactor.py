...
class TestPrecomputeEngine(unittest.TestCase):
    def test_clean_caption(self):
        ...
        self.assertEqual(clean_caption('"""Text with """inner""" quotes"""'), 'Text with inner quotes')
        
        # Test with user example
        user_example = '"""In this Thursday, Sept. 20, 2018, photo... (AP Photo/Damian Dovarganes)"""'
        expected = 'In this Thursday, Sept. 20, 2018, photo... (AP Photo/Damian Dovarganes)'
    ...
    def test_sample_caption(self):
        captions = ["Short", "Medium length caption", "Very long caption with many words"]
