...
def parse_args():
    ...
    parser.add_argument("--image_field", type=str, default="image", help="Column name for images or URLs")
    parser.add_argument("--caption_fields", type=str, nargs="*", default=[], help="List of caption columns")
    parser.add_argument("--vae_path", type=str, default="REPA-E/e2e-qwenimage-vae", help="Path to VAE model")
    parser.add_argument("--resolution_buckets", type=str, default="[(256,256)]", help="Resolution buckets (e.g. '[(256,256)]' or '256,256')")
    parser.add_argument("--output_dir", type=str, required=True, help="Directory to save processed dataset")
    parser.add_argument("--batch_size", type=int, default=50, help="Batch size")
    parser.add_argument("--range", type=int, default=-1, help="Range of images to process (for testing)")
