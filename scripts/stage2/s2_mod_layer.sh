#!/bin/bash
# 2.2a gate arm B: single-stream modulation = layer (shared per-layer MLP ->
# fewer params), h1024 d24 all-single, 8K steps @256p, 1x4090 Inspire GPU job.
...
RUN_NAME=${RUN_NAME:-s2-mod-layer}
